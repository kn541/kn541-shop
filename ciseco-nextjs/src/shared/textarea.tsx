  ...
  return (
    <span
      ...
      className={clsx([
        ...
        'before:absolute before:inset-px before:rounded-xl before:bg-white before:shadow-sm',
    ...
    >
      <Headless.Textarea
        ...
        className={clsx([
          // Basic layout
          'relative block h-full w-full appearance-none rounded-xl px-[calc(--spacing(3.5)-1px)] py-[calc(--spacing(2.5)-1px)] sm:px-[calc(--spacing(3)-1px)] sm:py-[calc(--spacing(1.5)-1px)]',
          // Typography
